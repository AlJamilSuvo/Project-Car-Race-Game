...
public class Collision {
	...
	public static boolean testInterSection(EntityPack c0, Entity c1){
	...
	private static float[] computeInterval(EntityPack C,Vector3f D){
		float max,min;
		min=Vector3f.dot(D,C.getVertex(0));
		max=min;
		for (int i=1;i<C.getVertexNumber();i++){
	...
	public static boolean testInterSection(EntityPack c0, EntityPack c1){
